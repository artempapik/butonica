...
const showProductInfo = (e, menuContent) => {
...
const createProductModal = () => {
    ...
    $(productModal.querySelector('select')).select2({ minimumResultsForSearch: -1 })
    ...
    for (const stock of stocksNames) {
        ...
        stockPriceInput.onpointerup = e => createCalculatorValueSpan(stockPriceInput, e)
