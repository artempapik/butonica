...
const changelogs = [
        ...
        changes: [
            {
                ...
                text: 'тепер ви можете створювати нагадування для своїх майбутніх замовлень! Відповідна опція знаходиться поруч із кнопкою створення online-замовлень'
            },
            {
                type: CHANGELOG_TYPES.fire,
                text: '«Загальна статистика» отримала редизайн: графіки виручки змін, прибутку, доходів та витрат і рентабельності отримали іконки та середні значення за період'
            },
            {
                type: CHANGELOG_TYPES.fire,
                text: 'розділ із налаштуваннями компанії отримав редизайн – тепер ви можете вказувати бажаний прибуток за день, тиждень і місяць, вказані цілі відображатимуться у статистиці продажів'
            }
        ]
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'тепер при оформленні замовлення ви можете вказати, у якій соцмережі вели переписку із клієнтом, і Бутоніка збереже посилання на переписку при перегляді замовлення'
            },
            {
                type: CHANGELOG_TYPES.fire,
                text: 'якщо при оформленні замовлення ваш замовник і отримувач – це одна людина, ви можете відмітити це при вказанні отримувача'
            },
            {
                type: CHANGELOG_TYPES.bug,
                text: 'фікс помилки незаповнення номеру після вибору клієнта до замовлення'
            }
        ]
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: "реалізовано збереження ваших замовлень та поставок у чернетку! Тепер ви можете не перейматися, що випадково закрили майже заповнену поставку або терміново треба створити замовлення для іншого клієнта – Butonica пам'ятатиме усі введені дані"
            },
            {
                type: CHANGELOG_TYPES.fire,
                text: 'вводити номер телефона при створенні клієнтів і замовлень стало значно зручніше – для цього тепер використовується спеціальне поле; також номер можна миттєво вставляти з буферу обміну'
            }
        ]
    },
    {
        ...
        changes: [
            {
                ...
                text: 'оновлення дизайну – стало менше заокруглень'
            },
            {
                text: 'тепер, якщо у вас немає жодного товару, вікна зі створенням поставки, списання та інвентаризації не відкриються'
            },
            {
                text: 'тепер річна статистика приховується, якщо немає відповідних даних'
            }
        ]
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'тепер можна натискати на товари у розділі «Залишки» – спливаюче вікно покаже, у яких саме букетах і замовленнях було використано товар'
            },
            {
                type: CHANGELOG_TYPES.fire,
                text: 'меню «Продаж» у телефонному режимі стало ще зручніше – асортимент відображається списком, а каса приховується у спливаючому вікні'
            },
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'додавання товарів до корзини тепер супроводжується анімацією, а відсутність результатів пошуку – підсвічено картинкою'
            }
        ]
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.exclamation,
                text: "тепер при перегляді замовлення з'явилася іконка, навівши на яку можна переглянути, на якій зміні або ким було створено замовлення"
            },
            {
                type: CHANGELOG_TYPES.bug,
                text: 'фікс багу розрахування кількості днів до замовлення'
            },
            {
                text: 'у профілі тепер можна переглянути дату оплати підписки'
            }
        ]
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'тепер у залишках поруч із ціною закупівлі ви бачите різницю порівняно з попередньою ціною (на відповідну комірку в таблиці можна навести та побачити значення)'
            },
            {
                type: CHANGELOG_TYPES.fire,
            ...
            {
                type: CHANGELOG_TYPES.fire,
                text: 'авторизуватися в Butonica ще ніколи не було настільки легко – просто введіть ваш PIN-код'
            },
            {
                type: CHANGELOG_TYPES.fire,
            ...
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'перенесення фільтрацій за датою до заголовків таблиць, запровадження нових випадаючих списків і календаря в усіх розділах'
            },
            {
                type: CHANGELOG_TYPES.exclamation,
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.success,
                text: 'статистику продаж – реалізовано! Переглядайте зведення своїх продажів та замовлень, середній чек, топи продажів та списань за день, тиждень і місяць у вигляді'
            },
            {
                type: CHANGELOG_TYPES.bug,
                text: 'пофікшено баг із скролом за спливаючим вікном при відображенні екранної клавіатури'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'формат дати всіх розділів став зручнішим і легшим для сприйняття'
            },
            {
                type: CHANGELOG_TYPES.bug,
    ...
    },
    {
        ...
        changes: [
            ...
            {
                text: 'оптимізація бази: при перегляді товарів тепер не завантажуються всі фото'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.fire,
                text: 'тепер ви можете шукати замовлення в очікуванні за номером – для цього просто натисніть 🔍 у першому стовчику таблиці та введіть початок номеру'
            },
            {
                type: CHANGELOG_TYPES.exclamation,
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.bug,
                text: 'декілька фіксів розмірів фото для товарів і букетів на пристроях Apple, додано тіні'
            },
            {
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.success,
                text: 'меню «Продаж» повністю адаптовано для телефонного режиму'
            },
            {
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.success,
                text: 'Butonica тепер доступна у вигляді PWA! Тепер ви можете встановити сервіс на домашній екран і користуватися ним як мобільним додатком'
            },
            {
                type: CHANGELOG_TYPES.fire,
                text: 'новий компонент «калькулятор», який дозволяє швидше та зручніше вводити числові дані'
            },
            {
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.success,
                text: 'новий розділ «Загальна статистика»'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.fire,
                text: "на кожному розділі тепер присутня анімація завантаження – особливо корисно для повільного інтернету або значної кількості елементів у таблиці"
            },
            {
                type: CHANGELOG_TYPES.exclamation,
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'тепер скасувати замовлення може тільки директор, адмін або той, хто його створював'
            },
            {
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'завершено розділ «Букети та композиції»; букети тепер відображаться в продажах та при продажі розкладаються на квіти та коректно списуються'
            },
            {
                type: CHANGELOG_TYPES.fire,
                text: 'завершено розділ «Мітки»; для флористів і менеджерів пункт не відображається'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'завершено розділ «Витрати магазину», його можуть переглядати лише директор і адмін'
            },
            {
                text: 'іконка профіля користувача тепер відображає кількість днів до закінчення підписки'
            },
            {
                text: 'завершено базовий функціонал розділу «Букети та композиції»'
            }
        ]
    },
    {
        ...
        changes: [
            ...
            {
                text: 'оптимізація бази даних для збереження великої кількості фото'
            }
        ]
    },
    {
        ...
        changes: [
            ...
            {
                text: 'всі фото стали заокруглені та стали відбивати невеликі тіні'
            },
            {
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'до замовлення тепер можна додавати фото'
            },
            {
                type: CHANGELOG_TYPES.fire,
    ...
    },
    {
        ...
        changes: [
            ...
            {
                text: 'завершено базовий функціонал розділу «Робочі зміни»'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'завершено розділ «Списання»'
            }
        ]
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'завершено базовий функціонал розділу «Продаж»'
            },
            {
                type: CHANGELOG_TYPES.fire,
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'товари тепер можуть мати фото'
            },
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'завершено розділи «Інвентаризація» та «Клієнти»'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.fire,
                text: 'завершено розділи «Компанія», «Торгові точки», «Каси», «Працівники», «Категорії», «Товари», «Постачальники» та «Поставки»'
            },
            {
                type: CHANGELOG_TYPES.exclamation,
