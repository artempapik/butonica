...
const changelogs = [
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.fire,
                text: 'меню «Продаж» у телефонному режимі стало ще зручніше – асортимент відображається списком, а каса приховується у спливаючому вікні. Додавання товарів до корзини тепер супроводжується анімацією'
            }
        ]
    },
    {
