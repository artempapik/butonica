...
const changelogs = [
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'перенесення фільтрацій за датою до заголовків таблиць, запровадження нових випадаючих списків і календаря в усіх розділах сайту'
            },
            {
                type: CHANGELOG_TYPES.exclamation,
    ...
    },
    {
        ...
        changes: [
            {
                type: CHANGELOG_TYPES.fire,
                text: 'завершено розділ меню «Витрати магазину», його можуть переглядати лише директор і адмін'
            },
            {
...
const randomFacts = [
    'Від того, звідки росте квітконос кімнатної орхідеї, залежить, скільки ще вона буде цвісти: якщо від центру – цвітіння відбувається востаннє'
]
