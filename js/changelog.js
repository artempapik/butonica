...
const changelogs = [
    {
        ...
        changes: [
            ...
            {
                text: 'тепер річна статистика приховується, якщо нема відповідних даних'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.exclamation,
                text: 'перенесення фільтрацій за датою до заголовків таблиць, запровадження нового календаря, випадаючих списків і калькулятора в усіх розділах сайту'
            },
            {
                type: CHANGELOG_TYPES.exclamation,
