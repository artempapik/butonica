        ...
        changes: [
            {
                ...
                text: 'тепер ви можете змінювати ціну продажу для товарів прямо з поточної продажі! Неймовірно спрощує розрахунок кожного вашого продажу. А робоча зміна відображає зміну ціни товару через спеціальну плашку'
            },
            {
