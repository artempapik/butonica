...
const changelogs = [
    {
        ...
        changes: [
            ...
            {
                text: 'компонент «Калькулятор» запроваджено у меню початку зміни та меню каси'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            ...
            {
                type: CHANGELOG_TYPES.bug,
                text: 'натискання на елемент меню, на якому ви вже знаходитеся, більше не призводить до перезавантаження сторінки'
            }
        ]
    },
    {
...
const randomFacts = [
    'Гортензію краще тримати в горщиках - так вона швидше цвіте і радує господарів цвітом своїм гарним красівим дуже класним'
]
