        ...
        changes: [
            {
                ...
                text: "всі ваші недоставлені замовлення можна відправити у друк для кур'єра! Для таких замовлень тепер існує відповідна кнопка, особливо зручно буде під час свят"
            }
        ]
    },
    {
