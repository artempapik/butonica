...
const createClientRow = client => {
    ...
    tr.onpointerup = e => {
        ...
        clientInfoModal.querySelector('.client-email').textContent = client.email
        clientInfoModal.querySelector('.client-birth-date').textContent = formatDate(client.birthDate, false)
        ...
        clientInfoModal.querySelector('.client-comment').textContent = client.comment
