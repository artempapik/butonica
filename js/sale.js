...
const showCashRegisterOperations = () => {
    showPageLoad()
    const operations = cashRegisterOperationsModal.querySelectorAll('input[name=operation-type]')
    operations.item(0).parentNode.classList.add('checked')
    operations.item(1).parentNode.classList.remove('checked')

    operations.forEach(o => o.onclick = () => {
        operations.forEach(o => o.parentNode.classList.remove('checked'))
        o.parentNode.classList.add('checked')
    })
